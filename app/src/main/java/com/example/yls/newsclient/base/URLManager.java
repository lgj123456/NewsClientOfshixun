...
public class URLManager {
    ...
    // 支持的一些新闻类别类别id如下：
    public static int perPageSize = 20;
    ...
    public static String getUrl(String channelId, int pageNum) {
        // http://c.m.163.com/nc/article/headline/T1348647909107/0-20.html
        return "http://c.m.163.com/nc/article/headline/" + channelId + "/" + (pageNum * perPageSize) + "-20.html";
    }
